...
export const variants: OrderVariantOption[] = [
  { id: "v1", label: "Sabor: Baunilha · Peso: 900 g", priceCents: 12990, sku: "WHEY-BAU-900", outOfStock: false },
  { id: "v2", label: "Sabor: Chocolate · Peso: 900 g", priceCents: 13490, sku: "WHEY-CHO-900", outOfStock: true },
]

export const lines: OrderFormLine[] = [
  { variantId: "v1", productName: "Whey Protein", variantLabel: "Sabor: Baunilha · Peso: 900 g", unitPriceCents: 12990, quantity: 2, outOfStock: false },
  { variantId: "v3", productName: "Coqueteleira", variantLabel: null, unitPriceCents: 2490, quantity: 1, outOfStock: true },
]
