...
export const SEARCH_SCOPE = "shrink-0 border-r bg-shop-fill px-3 text-base text-shop-on-background outline-none focus-visible:bg-shop-line shop-md:text-[13px]"
