...
const bands: ArrangementBand[] = [
  ...
  },
  {
    ...
    background: null,
    isActive: true,
    components: [{ id: "2", kind: "BENEFITS", title: null, span: "FULL", isActive: true }],
  },
  {
    id: "band-3",
    background: null,
    isActive: true,
    components: [
      { id: "3", kind: "HEADING", title: "Novidades da semana", span: "FULL", isActive: true },
      { id: "4", kind: "PRODUCTS", title: null, span: "FULL", isActive: true, deletable: false },
    ],
  },
  {
    id: "band-4",
