...
// Block
import { BannerForm, EMPTY_BANNER, type BannerFormValues } from "./banner-form"
...
const meta = {
  ...
  render: function Live(args) {
    ...
    return <BannerForm {...args} value={value} onChange={setValue} />
  },
  decorators: [
    (Story) => (
...
} satisfies Meta<typeof BannerForm>
