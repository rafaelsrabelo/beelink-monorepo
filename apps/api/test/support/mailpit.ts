...
/**
 * Waits for the newest message sent to an address — with a given subject, when one inbox gets
 * more than one kind of mail. Mail leaves the API asynchronously.
 */
export async function waitForMessage(to: string, timeoutMs = 10_000, subject?: string): Promise<MailpitMessage> {
