  ...
  stores: {
    ...
    home: {
      ...
      cards: {
        ...
        categoriesTitle: "Sort what you sell",
        categoriesText: "Categories and subcategories become your shop's menu.",
        categoriesAction: "Create a category",
        showcaseTitle: "Pick the home's highlights",
        showcaseText: "Mark a category as featured and it becomes a banner on the landing page.",
        showcaseAction: "Pick highlights",
