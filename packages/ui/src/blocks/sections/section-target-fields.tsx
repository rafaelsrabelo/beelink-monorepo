...
import type { SectionFormTarget, SectionFormValues, SectionTargetOption } from "./section-form-types"

export interface SectionTargetFieldsProps {
 ...
 */
export function SectionTargetFields({
  value,
  onChange,
  categories,
  products,
  ...
  const picker = (
    ...
    options: readonly SectionTargetOption[],
    label: string,
    placeholder: string,
  ) => (
    <Field>
    ...
    <>
      <Field>
        ...
        <Select
          disabled={disabled}
          value={value.target}
          onValueChange={(next: string | null) => set("target", (next ?? "CATEGORY") as SectionFormTarget)}
        >
